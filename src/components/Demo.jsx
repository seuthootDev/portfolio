      ...
      <div className="container mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-800 rounded-lg p-4 border border-gray-400/30">
              ...
              <p className="text-sm text-gray-400 mt-2">노드 기반 워크플로우를 구성하고 실행하는 화면</p>
            </div>
            
            {/* 스크린샷 2 - 워크플로우 에디터 */}
            <div className="bg-gray-800 rounded-lg p-4 border border-gray-400/30">
              <h4 className="font-bold text-white mb-3">컨투어</h4>
              <div className="aspect-video bg-gray-900 rounded-lg flex items-center justify-center overflow-hidden">
                <img
              ...
              <p className="text-sm text-gray-400 mt-2">가스 농도 컨투어 맵을 통해 위험 구역을 시각화</p>
            </div>
            
            {/* 스크린샷 3 - 3D 시각화 */}
            <div className="bg-gray-800 rounded-lg p-4 border border-gray-400/30">
              <h4 className="font-bold text-white mb-3">클리핑</h4>
              <div className="aspect-video bg-gray-900 rounded-lg flex items-center justify-center overflow-hidden">
                <img
              ...
              <p className="text-sm text-gray-400 mt-2">3D 모델을 절단해 내부 구조를 확인하는 클리핑 기능</p>
            </div>
            
            {/* 스크린샷 4 - 대시보드 */}
            <div className="bg-gray-800 rounded-lg p-4 border border-gray-400/30">
              <h4 className="font-bold text-white mb-3">도면편집</h4>
              <div className="aspect-video bg-gray-900 rounded-lg flex items-center justify-center overflow-hidden">
                <img
              ...
              <p className="text-sm text-gray-400 mt-2">트랙볼 등 입력 장치를 이용한 오브젝트 변환 및 추가·삭제</p>
            </div>

            {/* 스크린샷 5 - 가스 클라우드 */}
            <div className="bg-gray-800 rounded-lg p-4 border border-gray-400/30">
              <h4 className="font-bold text-white mb-3">가스 클라우드</h4>
              <div className="aspect-video bg-gray-900 rounded-lg flex items-center justify-center overflow-hidden">
                <img
              ...
              <p className="text-sm text-gray-400 mt-2">가스 확산 데이터를 클라우드 형태로 시각화</p>
            </div>

            {/* 스크린샷 6 - 대시보드 */}
            <div className="bg-gray-800 rounded-lg p-4 border border-gray-400/30">
              <h4 className="font-bold text-white mb-3">대시보드</h4>
              <div className="aspect-video bg-gray-900 rounded-lg flex items-center justify-center overflow-hidden">
                <img
